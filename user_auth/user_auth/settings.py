...
SECRET_KEY = 'django-insecure-h7g1m=9ggl^f!)b*40(6ti-uzims1r10up@q6jkz8g^invreaw'
...
EMAIL_HOST_PASSWORD = "oqyh eraj zfgu edvr"  # Replace with an app password if using Gmail
